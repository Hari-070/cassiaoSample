...
import TypingAnimation from '../components/TypingComponent'
        ...
        {/* <div className='home'> */}
            <div  className='home-hero'>
              ...
              <div className='home-hero-boxf3'>
                <span style={{color:"rgb(186, 15, 15)",fontSize:"17px",fontWeight:"700"}} className='sm:font-medium'><span style={{color:"white", fontWeight:"500"}}>The</span> Magic Begins with Every Drop of Lemon Syrup &nbsp; </span>
                  <TypingAnimation/>
              </div>
